...
vim.keymap.set("t", "dd", "<Esc>")            -- Выйти из терминала
...
-- Файловый менеджер
vim.keymap.set("n", "<M-d>", ":Neotree toggle float<CR>") -- Открыть/Закрыть файловое дерево в плавающем режиме
vim.keymap.set("n", "<M-e>", ":Neotree toggle left<CR>") -- Открыть/Закрыть файловое дерево слева сбоку
...
-- Разделение экрана
-- vim.keymap.set("n", "<C-Shist-v>", ":vsplit<CR>") -- Разделить экран по вертикали (окна снизу и сверху символа <->)
-- vim.keymap.set("n", "<C-Shist-h>", ":split<CR>") -- Разделить экран по горизонтали (окно|окно)

-- Удаление буфера
vim.keymap.set('n', '<leader>X', ':BufferLinePickClose<CR>')
vim.keymap.set("n", "<leader>x", ":BufferLineSortByTabs<CR>:BufferLineCloseRight<CR>")

vim.keymap.set("i", "jk", "<Esc>") -- Аналог для клавишы <Esc>
